...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! #~/component */ "./dist/src/component.js");
/* harmony import */ var _signal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! #~/signal */ "./dist/src/signal.js");
...
function resolveChild({ child, registry, root, }) {
    if (child instanceof _component__WEBPACK_IMPORTED_MODULE_2__.Component) {
        return render({ root: child, registry });
    }
    ;
    if (child instanceof _signal__WEBPACK_IMPORTED_MODULE_3__.Signal) {
        ...
        const mountForValue = (value) => {
            if (value instanceof _component__WEBPACK_IMPORTED_MODULE_2__.Component) {
        ...
        const unsubscribe = child.subscribe((value) => {
            ...
            if (previous instanceof _component__WEBPACK_IMPORTED_MODULE_2__.Component) {
...
function render({ root, registry, }) {
    ...
    for (const [key, value] of Object.entries(root.config)) {
        ...
        if (value instanceof _signal__WEBPACK_IMPORTED_MODULE_3__.Signal) {
            const v = value.value;
            if (v == null) {
...
class Bridge {
    ...
    of(config) {
        ...
        config.id = uuid;
        const component = new _component__WEBPACK_IMPORTED_MODULE_2__.Component(this.symbol, config);
...
class If {
    ...
    of(config) {
        ...
        const componentSignal = new _signal__WEBPACK_IMPORTED_MODULE_3__.Signal(null);
        // Ensure we don't destroy the real `config` on unmount.
        const getNewConfig = () => {
            return (0,lodash_es__WEBPACK_IMPORTED_MODULE_1__["default"])(config);
        };
        const wrapper = new _component__WEBPACK_IMPORTED_MODULE_2__.Component(this.symbol, {
        ...
        const unsubscribe = conditionSignal.subscribe((v) => {
            ...
            if (v) {
                componentSignal.value = new _component__WEBPACK_IMPORTED_MODULE_2__.Component(this.symbol, getNewConfig());
            }
            else {
...
class Div {
    symbol = Symbol('div');
    of(config) {
        return new _component__WEBPACK_IMPORTED_MODULE_2__.Component(this.symbol, config);
    }
    ;
}
;
class Button {
    ...
    of(config) {
        const component = new _component__WEBPACK_IMPORTED_MODULE_2__.Component(this.symbol, config);
        const nested = (0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Bridge, { func: (parent) => {
                const button = parent;
...
/* harmony import */ var rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rynth/jsx-runtime */ "./dist/src/jsx-runtime.js");
/* harmony import */ var _signal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! #~/signal */ "./dist/src/signal.js");
/* harmony import */ var _html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! #~/html */ "./dist/src/html.js");
/* harmony import */ var _hook__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! #~/hook */ "./dist/src/hook.js");




const planet = new _signal__WEBPACK_IMPORTED_MODULE_1__.Signal("Earth");
const style = new _signal__WEBPACK_IMPORTED_MODULE_1__.Signal("color: green;");
const rickrolled = new _signal__WEBPACK_IMPORTED_MODULE_1__.Signal(false);
const component = (0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_html__WEBPACK_IMPORTED_MODULE_2__.Div, { children: [(0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_html__WEBPACK_IMPORTED_MODULE_2__.Div, { id: 'foo', style: style, children: ["Hello, ", planet, "!"] }), (0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_html__WEBPACK_IMPORTED_MODULE_2__.Button, { click: () => {
                console.log("Never gonna give you up...");
                rickrolled.value = true;
                window.open('https://www.youtube.com/watch?v=dQw4w9WgXcQ');
            }, children: "Click here" }), (0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_html__WEBPACK_IMPORTED_MODULE_2__.If, { condition: rickrolled, children: [(0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_html__WEBPACK_IMPORTED_MODULE_2__.Div, { children: "Rickrolled!" }), (0,rynth_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_html__WEBPACK_IMPORTED_MODULE_2__.Button, { click: () => {
                        console.log("Never gonna let you down...");
                        rickrolled.value = false;
                    }, children: "Close" })] })] });
const registry = new Map();
let node = (0,_html__WEBPACK_IMPORTED_MODULE_2__.render)({ root: component, registry: registry, });
(0,_hook__WEBPACK_IMPORTED_MODULE_3__.hook)(component, (component) => {
    // console.log(registry.size);
    // console.log("Re-rendering...");
    let oldNode = registry.get(component.key);
    let newNode = (0,_html__WEBPACK_IMPORTED_MODULE_2__.render)({ root: component, registry: registry, });
